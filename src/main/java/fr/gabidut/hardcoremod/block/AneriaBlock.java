...
package fr.gabidut.hardcoremod.block;
...
import fr.gabidut.hardcoremod.item.PetaleaneriaItem;
import fr.gabidut.hardcoremod.HardcoreModModElements;

@HardcoreModModElements.ModElement.Tag
public class AneriaBlock extends HardcoreModModElements.ModElement {
	@ObjectHolder("hardcore_mod:aneria")
	public static final Block block = null;
	public AneriaBlock(HardcoreModModElements instance) {
		super(instance, 1);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).lightValue(15));
			setRegistryName("aneria");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PetaleaneriaItem.block, (int) (1)));
		}
